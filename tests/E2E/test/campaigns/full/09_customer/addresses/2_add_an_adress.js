...
const {accountPage, addressPage} = require('../../../../selectors/FO/add_account_page');
...
scenario('Add an address', client => {
  ...
  scenario('Change the required fields addresses parameter and save it ', client => {
    ...
    test('should click on "set required fields for this section" button ', () => client.waitForVisibleAndClick(Addresses.required_fields_button));
    test('should select all the checkbox', () => client.waitForVisibleAndClick(Addresses.select_all_field_name));
  ...
  scenario('Add a first address and verify the necessary fields ', client => {
    ...
    test('should set the "first name" input', () => client.waitAndSetValue(addressPage.firstname_input, addressData.first_name));
    test('should set the "last name" input', () => client.waitAndSetValue(addressPage.lastname_input, addressData.last_name));
    test('should choose the "Country" input', () => client.waitAndSelectByVisibleText(addressPage.choose_country_input, addressData.country));
    test('should click on "Save" button', () => client.waitForExistAndClick(accountPage.adr_save));
    test('should check the "company" message validation', () => client.checkElementValidation(addressPage.company_input, "Veuillez renseigner ce champ."));
    test('should set the "company" input', () => client.waitAndSetValue(addressPage.company_input, addressData.company));
    test('should click on "Save" button', () => client.waitForExistAndClick(accountPage.adr_save));
    test('should check the "VAT number" message validation', () => client.checkElementValidation(addressPage.vat_number_input, "Veuillez renseigner ce champ."));
    test('should set the "VAT number" input', () => client.waitAndSetValue(addressPage.vat_number_input, addressData.vat_number));
    test('should click on "Save" button', () => client.waitForExistAndClick(accountPage.adr_save));
    test('should check the "address" message validation', () => client.checkElementValidation(addressPage.adr_address, "Veuillez renseigner ce champ."));
    test('should set the "address" input', () => client.waitAndSetValue(addressPage.adr_address, addressData.address + date_time));
    test('should click on "Save" button', () => client.waitForExistAndClick(accountPage.adr_save));
    test('should check the "address complement" message validation', () => client.checkElementValidation(addressPage.address_Complement_input, "Veuillez renseigner ce champ."));
    test('should set the "address complement" input', () => client.waitAndSetValue(addressPage.address_Complement_input, addressData.second_address));
    test('should click on "Save" button', () => client.waitForExistAndClick(accountPage.adr_save));
    test('should check the "zip/postal Code" message validation', () => client.checkElementValidation(addressPage.adr_postcode, "Veuillez renseigner ce champ."));
    test('should set the "zip/postal Code" input', () => client.waitAndSetValue(addressPage.adr_postcode, addressData.ZIP));
    test('should click on "Save" button', () => client.waitForExistAndClick(accountPage.adr_save));
    test('should check the "city" message validation', () => client.checkElementValidation(addressPage.adr_city, "Veuillez renseigner ce champ."));
    test('should set the "city" input', () => client.waitAndSetValue(addressPage.adr_city, addressData.city));
    test('should click on "Save" button', () => client.waitForExistAndClick(accountPage.adr_save));
    test('should check the "phone" message validation', () => client.checkElementValidation(addressPage.phone_input, "Veuillez renseigner ce champ."));
    test('should set the "phone" input', () => client.waitAndSetValue(addressPage.phone_input, addressData.home_phone));
    test('should click on "Save" button', () => client.waitForExistAndClick(accountPage.adr_save));
  ...
  scenario('Verify that the address is displayed with all the fields filled in the Back Office', client => {
    ...
    test('should click on "Search" button to display all the fields', () => client.waitForExistAndClick(Addresses.search_button));
    test('should get the address ID', () => client.getTextInVar(Addresses.address_id, 'address_id'));
    test('should click on "Edit" button', () => client.waitForExistAndClick(Customer.edit_address_button));
    ...
    test('should click on "set required fields for this section" button ', () => client.waitForVisibleAndClick(Addresses.required_fields_button));
    test('should uncheck all checkbox', () => {
      return promise
  ...
  scenario('Check customer address then create a new address in the Front Office  ', client => {
    ...
    scenario('Add a new address', client => {
      test('should click on "Create new address" button', () => client.waitForVisibleAndClick(addressPage.create_new_address_button));
      scenario('Verify if the fields "Alias", "Company", "VAT number", "Address Complement", "Phone" are well displayed as optional', client => {
        test('should verify that the "Alias" input is displayed as optional', () => client.waitForVisible(Addresses.optional_text.replace('%ID', 1)));
        test('should verify that the "Company" input is displayed as optional', () => client.waitForVisible(Addresses.optional_text.replace('%ID', 4)));
        test('should verify that the "VAT number" input is displayed as optional', () => client.waitForVisible(Addresses.optional_text.replace('%ID', 5)));
        test('should verify that the "Address Complement" input is displayed as optional', () => client.waitForVisible(Addresses.optional_text.replace('%ID', 7)));
        test('should verify that the "Phone" input is displayed as optional', () => client.waitForVisible(Addresses.optional_text.replace('%ID', 11)));
      }, 'customer');
      scenario('Fill the fields "First name", "Last name", "Company", "Address", "Zip/Postal Code", "City", "Country" and save a new address', client => {
        test('should set the "first name" input ', () => client.waitAndSetValue(addressPage.firstname_input, newAddressData.first_name));
        test('should set the "last name" input', () => client.waitAndSetValue(addressPage.lastname_input, newAddressData.last_name));
        test('should set the "company" input', () => client.waitAndSetValue(addressPage.company_input, newAddressData.company));
        test('should set the "address" input', () => client.waitAndSetValue(addressPage.adr_address, newAddressData.address + date_time));
        test('should set the "zip/postal Code" input', () => client.waitAndSetValue(addressPage.adr_postcode, newAddressData.ZIP));
        test('should set the "city" input', () => client.waitAndSetValue(addressPage.adr_city, newAddressData.city));
        test('should choose the "Country" input', () => client.waitAndSelectByVisibleText(addressPage.choose_country_input, newAddressData.country));
        test('should click on "Save" button', () => client.waitForExistAndClick(accountPage.adr_save));
  ...
  scenario('Check the created address in the Back Office ', client => {
    test('should go to the back office', () => client.switchWindow(0));
