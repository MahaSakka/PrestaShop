...
scenario('Edit a state', client => {
  ...
  test('should set the "Name" input', () => client.waitAndSetValue(State.name_input, editState.name));
  test('should set the "ISO code" input', () => client.waitAndSetValue(State.iso_code_input, editState.iso_code));
  test('should choose the "Country" select', () => client.waitAndSelectByVisibleText(State.country_select, editState.country));
  test('should choose the "Zone" select', () => client.waitAndSelectByVisibleText(State.zone_select, editState.zone));
  test('should set the "Status" to "Yes"', () => client.waitForExistAndClick(State.status_state.replace('%status', "'active_on'")));
